namespace FFXCutsceneRemover.Resources
{
    ...
    public class MemoryLocationNames
    {
        ...
        public static string Camera_x = "Camera_x";
        public static string Camera_y = "Camera_y";
        public static string Camera_z = "Camera_z";
        ...
        public static string NPCLastInteraction = "NPCLastInteraction";
        public static string TidusActionCount = "TidusActionCount";
        public static string TidusXCoordinate = "TidusXCoordinate";
        ...
        public static string WendigoTransition = "WendigoTransition";
        public static string SpherimorphTransition = "SpherimorphTransition";
        public static string UnderLakeTransition = "UnderLakeTransition";
        ...
        public static string NatusTransition = "NatusTransition";
        ...
        public static string KilikaMapFlag = "KilikaMapFlag";
        ...
        public static string MRRFlag1 = "MRRFlag1";
        public static string MRRFlag2 = "MRRFlag2";
